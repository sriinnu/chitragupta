...
// ─── Re-export IncrementalPageRank from dedicated module ─────────────────────
// Split into graphrag-pagerank-incremental.ts for module size compliance (<450 LOC).
export { IncrementalPageRank } from "./graphrag-pagerank-incremental.js";
