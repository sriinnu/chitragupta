...
Niyanta is where Chitragupta's autonomy becomes policy and execution pressure. In the current runtime, it is one of the places where the broader Lucy/Scarlett model becomes concrete through orchestration, self-healing strategy selection, and Kartavya promotion.
