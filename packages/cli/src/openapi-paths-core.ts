	...
	return {
		"/api/sessions": {
			...
			post: {
						...
						"application/json": {
							schema: {
								...
								properties: {
									...
									sessionId: { type: "string", description: "Optional existing session to resume" },
									clientKey: { type: "string", description: "Stable client identity for a tab, window, or actor" },
									sessionLineageKey: { type: "string", description: "Explicit lineage identifier for intentional same-thread reuse" },
									lineageKey: { type: "string", description: "Alias for sessionLineageKey" },
									sessionReusePolicy: {
										type: "string",
										enum: ["isolated", "same_day"],
										description: "Session reuse policy. Defaults to isolated.",
									},
				...
				responses: {
					"201": jsonResponse("Session creation requested", {
						type: "object",
						properties: {
