...
const PAIRING_WORDS: readonly string[] = [
	...
	"ivory", "joker", "koala", "lyric", "marsh", "noble", "omega", "prism",
	...
	"quill", "robin", "slate", "tiger", "unity", "valve", "wired", "youth",
	"azure", "brave", "crest", "dusty", "eagle", "flock", "giant", "hover",
	"ivory", "jolly", "knack", "light", "motto", "nerve", "oxide", "pulse",
	"query", "rustic", "spark", "tempo", "upper", "vault", "woven", "zones",
	"apex", "blade", "cloak", "dune", "evoke", "flora", "glint", "helix",
	"image", "jewel", "kappa", "latch", "merit", "north", "onyx", "plank",
	"radar", "rivet", "scale", "twist", "umbra", "visor", "witch", "xerus",
	"alloy", "basil", "cedar", "drum", "elfin", "frost", "glyph", "hazel",
	"ivory", "lotus", "sigma", "theta", "ultra", "vapor", "whisk", "topaz",
	"amber", "beryl", "cliff", "diver", "entry", "flame", "grape", "hound",
] as const;
