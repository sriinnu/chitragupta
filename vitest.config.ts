...
export default defineConfig({
	test: {
		...
		alias: {
			...
			"@chitragupta/ui/components/status-bar": resolve(__dirname, "packages/ui/src/components/status-bar.ts"),
			"@chitragupta/ui/components/session-tree": resolve(__dirname, "packages/ui/src/components/session-tree.ts"),
			"@chitragupta/ui/theme": resolve(__dirname, "packages/ui/src/theme.ts"),
			"@chitragupta/ui/keys": resolve(__dirname, "packages/ui/src/keys.ts"),
